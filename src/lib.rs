...
#[derive(Debug)]
pub struct SmartDomusProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SmartDomusProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SmartDomus processing");
    
    let mut processor = SmartDomusProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SmartDomusProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SmartDomusProcessor::new(false);
